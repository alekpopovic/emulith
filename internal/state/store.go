...
func (s *Store) Reset(ctx context.Context) error {
	...
	for _, table := range []string{"azure_queue_messages", "sns_subscriptions", "sns_topics", "dynamodb_items", "dynamodb_attributes", "dynamodb_tables", "sqs_messages", "sqs_queues", "s3_objects", "s3_buckets"} {
